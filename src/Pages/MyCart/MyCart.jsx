...
const MyCart = () => {
    ...
    return (
        <div style={{Bacopacity:'.9'}} className="bg-[url('https://i.ibb.co/LZhwJ1T/workplace-business-modern-male-accessories-laptop-black-background-1.jpg')]  min-h-fit bg-opacity-0 bg-cover bg-no-repeat">
