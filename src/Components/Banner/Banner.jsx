        ...
        <div className='container mx-auto'>
            ...
            >
                <SwiperSlide>
                    ...
                    <div className="rounded-xl bg-cover bg-no-repeat h-[500px] bg-[#F7E5D5] card lg:card-side shadow-xl">
                        <div className="flex flex-col md:flex-row justify-center items-center ml-10">
                            ...
                            <img src="https://i.ibb.co/y8RCLwD/banner.png" alt="" className='md:w-1/2 md:h-full' />
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
